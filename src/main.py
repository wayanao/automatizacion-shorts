...
def run() -> None:
    ...
    print("[4/7] Descargando videos de fondo acordes con el versiculo...")
    ...
    final_video_path, music_attribution = build_video(
        background_paths,
        audio_path,
        words,
        work_dir / "short_final.mp4",
        music_mood=data.get("music_mood", "peaceful"),
    )

    print("[6/7] Se usará la miniatura automática de YouTube basada en el video...")
    thumbnail_path = None
